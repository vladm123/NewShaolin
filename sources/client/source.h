...
// surse c
// implementarea metodei de conectare la server
...
//handlere pentru comunicarea cu serverul

// conectare la server prin socketul sd, cu adresa Aadrr si portul Pport
int conectareServer(int *sd, char* Aaddr, int Pport);
